  ...
  return (
    ...
    {/* Page Title */}
      ...
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        <ul className="list-disc ml-6 space-y-2 text-sm md:text-md lg:text-lg text-slate-300">
        ...
        <ul className="list-disc ml-6 space-y-2 text-slate-300 text-sm md:text-md lg:text-lg">
...
const GuideCard = ({ title, children }) => (
  ...
  ">
    <h2 className="text-xl md:text-2xl font-bold mb-2 text-indigo-300">
      {title}
    </h2>
