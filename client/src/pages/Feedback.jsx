...
//     // Feedback component के शुरू में add करो:
//     useEffect(() => {
//         console.log("=== DEBUG CURRENT INTERVIEW ===");
//         console.log("Full currentInterview:", currentInterview);
...
//                 console.log(`Question ${i} feedbackObj:`, q.feedbackObj);
//                 console.log(`Question ${i} feedbackObj type:`, typeof q.feedbackObj);
//                 console.log(`Q${i} - feedbackObj keys:`, 
//                     q.feedbackObj ? Object.keys(q.feedbackObj) : 'undefined'
//                 );
//             });
//         }
//     }, [currentInterview]);
...
//     // Safe extraction
//     const score = currentInterview?.overallFeedback?.score || 0;
